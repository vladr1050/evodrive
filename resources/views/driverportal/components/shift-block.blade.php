...
@endphp
{{-- Layout mirrors Free Slot cards: time · hours · plate · full station address --}}
<div
...
>
    <div class="flex items-start justify-between gap-1 min-w-0">
        <div class="min-w-0 flex-1">
            ...
            @unless($hideStation)
                <div class="mt-1 text-[9px] font-medium {{ $isMyShift ? 'text-green-700/80' : 'text-slate-500' }} leading-snug">{{ $stationLabel }}</div>
            @endunless
        </div>
        @if($hasActions)
